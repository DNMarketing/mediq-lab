...
export default function DatenschutzPage() {
  return (
    <LegalShell title="Datenschutzerklärung">
      ...
      <p>
        <strong className="text-ink">1. Verantwortliche Stelle</strong>
        <br />
        [Name, Anschrift, Kontakt – siehe Impressum]
      </p>
      <p>
        <strong className="text-ink">2. Hosting</strong>
        <br />
      ...
      <p>
        <strong className="text-ink">3. Eingebettete Inhalte (Video)</strong>
        <br />
      ...
      <p>
        <strong className="text-ink">4. Weiterleitung zu Skool</strong>
        <br />
      ...
      <p>
        <strong className="text-ink">5. Deine Rechte</strong>
        <br />
